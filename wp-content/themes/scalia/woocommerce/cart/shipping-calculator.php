...
<form class="woocommerce-shipping-calculator shipping_calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<h4><a href="#" class="shipping-calculator-button"><?php esc_html_e( 'Calculate shipping', 'woocommerce' ); ?></a></h4>
	...
	<section class="shipping-calculator-form">
		...
		<?php wp_nonce_field( 'woocommerce-cart', 'woocommerce-shipping-calculator-nonce' ); ?>
	</section>
</form>
