...
<tr class="shipping">
	<th><?php
		if ( $show_package_details ) {
			...
			_e( 'Shipping and Handling', 'scalia' );
		}
	?></th>
	<td>
		<?php if ( ! empty( $available_methods ) ) : ?>
			...
			<?php elseif ( get_option( 'woocommerce_shipping_method_format' ) === 'select' ) : ?>
				...
				<select name="shipping_method[<?php echo $index; ?>]" data-index="<?php echo $index; ?>" id="shipping_method_<?php echo $index; ?>" class="shipping_method sc-combobox">
			...
			<?php else : ?>
				...
				<ul id="shipping_method" class="styled">
					<?php foreach ( $available_methods as $method ) : ?>
						<li>
							...
							<input type="radio" name="shipping_method[<?php echo $index; ?>]" data-index="<?php echo $index; ?>" id="shipping_method_<?php echo $index; ?>_<?php echo sanitize_title( $method->id ); ?>" value="<?php echo esc_attr( $method->id ); ?>" <?php checked( $method->id, $chosen_method ); ?> class="shipping_method sc-checkbox" />
						</li>
					<?php endforeach; ?>
				</ul>
