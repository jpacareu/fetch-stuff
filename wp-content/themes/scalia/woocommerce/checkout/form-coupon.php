...
<form class="checkout_coupon rounded-corners shadow-box shop_table cart clearfix" method="post">
	<div class="promo-code-heading alignleft styled-subtitle"><?php esc_html_e( 'Have A Promotional Code?', 'woocommerce' ) ?></div>
	...
	<div class="coupon-contents coupon alignright">
		...
		<button type="submit" class="sc-button" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'woocommerce' ); ?>"><?php esc_html_e( 'Apply coupon', 'woocommerce' ); ?></button>
	</div>
</form>
