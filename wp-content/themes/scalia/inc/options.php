		...
		$options['general']['subcats']['woocommerce'] = array(
			...
			'options' => array(
				...
				'woocommerce_catalog_image_width' => array(
					'title' => __('WooCommerce Catalog ImageWidth', 'thegem'),
					'type' => 'fixed-number',
					'min' => 0,
					'max' => 1000,
					'default' => 540,
				...
				'woocommerce_catalog_image_height' => array(
					'title' => __('WooCommerce Catalog Image Height', 'thegem'),
					'type' => 'fixed-number',
					'min' => 0,
					'max' => 1000,
					'default' => 670,
				...
				'woocommerce_product_image_width' => array(
					'title' => __('WooCommerce Single Product ImageWidth', 'thegem'),
					'type' => 'fixed-number',
					'min' => 0,
					'max' => 1000,
					'default' => 880,
				...
				'woocommerce_product_image_height' => array(
					'title' => __('WooCommerce Single Product ImageHeight', 'thegem'),
					'type' => 'fixed-number',
					'min' => 0,
					'max' => 1500,
					'default' => 1100,
				...
				'woocommerce_thumbnail_image_width' => array(
					'title' => __('WooCommerce Product Thumbnails Image Width', 'thegem'),
					'type' => 'fixed-number',
					'min' => 0,
					'max' => 1000,
					'default' => 180,
				...
				'woocommerce_thumbnail_image_height' => array(
					'title' => __('WooCommerce Product Thumbnails Image Height', 'thegem'),
					'type' => 'fixed-number',
					'min' => 0,
					'max' => 1000,
					'default' => 180,
