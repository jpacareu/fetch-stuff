...
add_filter('the_content', 'scalia_vc_run_shortcode', 7);
add_filter('widget_text', 'scalia_vc_run_shortcode', 7);
add_filter('the_excerpt', 'scalia_vc_run_shortcode', 7);

function scalia_vc_run_shortcode($content) {
	global $shortcode_tags;
	$orig_shortcode_tags = $shortcode_tags;
	remove_all_shortcodes();

	add_shortcode('vc_column', 'scalia_vc_column_shortcode');
	add_shortcode('vc_column_inner', 'scalia_vc_column_shortcode');
	add_shortcode('vc_row', 'scalia_vc_row_shortcode');
	add_shortcode('vc_row_inner', 'scalia_vc_row_shortcode');
	add_shortcode('vc_accordion', 'scalia_vc_accordion_shortcode');
	add_shortcode('vc_accordion_tab', 'scalia_vc_accordion_tab_shortcode');
	add_shortcode('vc_tabs', 'scalia_vc_tabs_shortcode');
	add_shortcode('vc_tour', 'scalia_vc_tour_shortcode');
	add_shortcode('vc_tab', 'scalia_vc_tab_shortcode');
	add_shortcode('vc_gmaps', 'scalia_vc_gmaps_shortcode');
...
function scalia_shortcodes_array_add_vc($shortcodes) {
...
add_filter('scalia_shortcodes_array', 'scalia_shortcodes_array_add_vc');

function scalia_getExtraClass($el_class) {
	$output = '';
	if ($el_class != '') {
...
function scalia_buildStyle($bg_image = '', $bg_color = '', $bg_image_repeat = '', $font_color = '', $padding = '', $margin_bottom = '') {
	$has_image = false;
	$style = '';
...
function scalia_wpb_js_remove_wpautop($content, $autop = false) {
...
function scalia_wpb_translateColumnWidthToSpan($width, $front = true) {
...
function scalia_wpb_widget_title($params = array('title' => '')) {
